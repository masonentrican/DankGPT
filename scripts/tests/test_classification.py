...
def main():
    ...
    # Train DataFrame
    logger.info(f"Train DataFrame:")
    logger.info("--------------------------------")
    logger.info(f"Train DataFrame Labels: \n\n{train_df['Label'].value_counts()}\n")
    logger.info(f"Train DataFrame Contents:\n\n{train_df}\n")
    
    # Validation DataFrame
    logger.info(f"Validation DataFrame:")
    logger.info("--------------------------------")
    logger.info(f"Validation DataFrame Labels: \n\n{val_df['Label'].value_counts()}\n")
    logger.info(f"Validation DataFrame Contents:\n\n{val_df}\n")

    # Test DataFrame
    logger.info(f"Test DataFrame:")
    logger.info("--------------------------------")
    logger.info(f"Test DataFrame Labels: \n\n{test_df['Label'].value_counts()}\n")
    logger.info(f"Test DataFrame Contents:\n\n{test_df}\n")
